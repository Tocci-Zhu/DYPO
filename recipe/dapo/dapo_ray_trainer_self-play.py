            ...
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    try:
                        ...
                        _log_prob_out = self.actor_rollout_wg.compute_log_prob(new_batch)
                        new_batch = new_batch.union(_log_prob_out)
                        seq_logprob = (new_batch.batch["log_probs"] * new_batch.batch["response_mask"]).sum(dim=-1)

                        # 将同一原始 prompt 的轨迹用 uid 分组
                        uids = new_batch.non_tensor_batch["uid"]
                        raw_prompts = new_batch.non_tensor_batch["raw_prompt_ids"]
                        ...
                        resp_mask = new_batch.batch["response_mask"].bool()
                        ...
                        # 覆盖回 batch
                        new_batch.non_tensor_batch["raw_prompt_ids"] = np.array(aug_raw_prompts, dtype=object)
