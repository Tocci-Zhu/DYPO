...
# from .format_fix import format_fix
"""
    ...
    try:
        if not isinstance(test_cases, dict):
            try:
                ...
                return 0.1, [{"error": "Invalid test_cases JSON format"}]
        ...
        if test_cases is not None and "assert_case" in test_cases and isinstance(test_cases.get("assert_case"), list):
            ...
            return 0.1, [{"error": "Invalid test_cases structure (missing inputs/outputs)"}]
