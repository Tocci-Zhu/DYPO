...
class RolloutConfig(BaseConfig):
    ...
    prefix_linear_max_ratio: float = 0.8
    prefix_linear_max_var: float = 0.1
    max_prefix_len: int = 8192
    min_prefix_ratio: float = 0.0
    max_prefix_ratio: float = 1.0
    prefix_reward_strategy: str = "all"
    prefix_reward_weight_alpha: float = 1.0
    prefix_reward_weight_beta: float = 1.0
