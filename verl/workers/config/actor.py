...
class FSDPActorConfig(ActorConfig):
    ...
    entropy_chunk_size: int = 64  # Batch dimension chunk size for entropy calculation
    entropy_seq_chunk_size: int = 512  # Sequence dimension chunk size for entropy calculation
    ...
    ppo_mini_batch_size: int = 256
    ppo_micro_batch_size: Optional[int] = 64
    ppo_micro_batch_size_per_gpu: Optional[int] = None  # deprecated
    use_dynamic_bsz: bool = False
    ppo_max_token_len_per_gpu: int = 16384
    clip_ratio: float = 0.2
    clip_ratio_low: float = 0.2
    ...
    kl_loss_coef: float = 0.001
    kl_loss_type: str = "low_var_kl"
    contrastive_loss_coef: float = 0.1
