...
def compute_sft_pure_loss(log_prob, response_mask):
    sft_losses = -log_prob
    sft_loss = verl_F.masked_mean(sft_losses, response_mask)
    return sft_loss

def compute_sft_token_loss(log_prob, response_mask):
    sft_losses = -log_prob
    sft_loss = verl_F.masked_mean(sft_losses, response_mask)
...
def compute_policy_loss(old_log_prob, log_prob, advantages, response_mask, loss_agg_mode: str = "seq-mean-token-mean",
